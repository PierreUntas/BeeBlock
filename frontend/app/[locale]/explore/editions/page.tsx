                ...
                <div className="mb-16">
                    ...
                    <div className="flex items-end justify-between border-b border-[var(--border)] pb-8">
                        ...
                        <div className="text-right hidden md:block">
                            <span className=" italic text-[48px] text-[var(--border-soft)] leading-none">{activeEditions.length}</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-[var(--border)] border border-[var(--border)]">
                        {filteredEditions.map((edition) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2 flex-1">
                                    <div className="flex items-start justify-between gap-2">
                                        <div>
                                            ...
                                            <h3 className=" text-[18px] font-normal text-[var(--text-primary)] leading-tight">
                                                {edition.title}
                                            </h3>
                                        </div>
                                ...
                                {/* Footer */}
                                <div className="border-t border-[var(--border-soft)] pt-4 flex items-end justify-between">
                                    <div>
                                        <p className="text-[9px] font-medium tracking-[0.1em] uppercase text-[var(--text-muted)] mb-0.5">{t('artistLabel')}</p>
                                        <p className="text-[13px] font-light text-[var(--text-primary)]">{artists.get(edition.artist)?.name}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[9px] font-medium tracking-[0.1em] uppercase text-[var(--text-muted)] mb-0.5">{t('editionLabel')}</p>
                                        <p className="text-[13px] font-light text-[var(--text-secondary)] font-mono">
            ...
            <div className="min-h-screen bg-[var(--bg-page)]">
                <div className="max-w-[960px] mx-auto px-6 pt-28 pb-20">
                    <div className="flex flex-col items-center justify-center py-12 gap-4">
                        <div className="w-8 h-8 border border-[var(--border)] border-t-[var(--text-primary)] rounded-full animate-spin" />
                        <p className="text-[13px] font-light text-[var(--text-muted)] tracking-[0.06em]">Chargement…</p>
                    </div>
                </div>
            </div>
        }>
